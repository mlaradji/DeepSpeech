...
def calculate_mean_edit_distance_and_loss(iterator, dropout, reuse):
    ...
    total_loss = tfv1.nn.ctc_loss(labels=batch_y, inputs=logits, sequence_length=batch_seq_len, ignore_longer_outputs_than_inputs=FLAGS.ignore_longer_outputs_than_inputs)
